#Stock screener that uses matplot as graph thing 
#Also grab chunk data from yahoo finance and has some indicator functions
#need to install matplot, numpy and other stuff - http://www.lfd.uci.edu/~gohlke/pythonlibs/
